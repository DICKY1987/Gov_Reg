...
SOURCE_FILES = {
    "NEWPHASEPLANPROCESS_AUTONOMOUS_DELIVERY_TEMPLATE_V3_2.json": ROOT / "NEWPHASEPLANPROCESS_AUTONOMOUS_DELIVERY_TEMPLATE_V3_2.json",
    "NEWPHASEPLANPROCESS_TECHNICAL_SPECIFICATION_V3_2.json": ROOT / "NEWPHASEPLANPROCESS_TECHNICAL_SPECIFICATION_V3_2.json",
    "NEWPHASEPLANPROCESS_INSTRUCTION_DOCUMENT_V3_2.json": ROOT / "NEWPHASEPLANPROCESS_INSTRUCTION_DOCUMENT_V3_2.json",
}
...
def run_sandbox_reorder_test(indexes: dict[str, Any]) -> dict[str, Any]:
    template_path = SOURCE_FILES["NEWPHASEPLANPROCESS_AUTONOMOUS_DELIVERY_TEMPLATE_V3_2.json"]
    spec_path = SOURCE_FILES["NEWPHASEPLANPROCESS_TECHNICAL_SPECIFICATION_V3_2.json"]
    ...
    build_index_for_rule(
        ...
        "id",
        "by_gate_id",
        sandbox_indexes["NEWPHASEPLANPROCESS_TECHNICAL_SPECIFICATION_V3_2.json"]["maps"],
    )
    build_index_for_rule(
        template_copy,
        "/validation_gates",
    ...
    key_sets_match = (
        ...
        set(indexes["NEWPHASEPLANPROCESS_TECHNICAL_SPECIFICATION_V3_2.json"]["maps"]["by_gate_id"])
        and set(sandbox_indexes["NEWPHASEPLANPROCESS_AUTONOMOUS_DELIVERY_TEMPLATE_V3_2.json"]["maps"]["by_gate_id"]) ==
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate deterministic semantic-ID indexes for the v3.2 governance docs.")

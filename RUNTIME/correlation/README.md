# DOC_ID: DOC-SCRIPT-1133
# Correlation Identifier Registry
...
Cross-subsystem correlation identifier
...
### Minting a New Correlation Identifier
...
- Format validator (regex: `^CORR-[0-9A-HJKMNP-TV-Z]{26}$`)

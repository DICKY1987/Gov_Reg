#!/usr/bin/env python3
# DOC_LINK: DOC-VALIDATOR-PATTERN-ID-REFERENCES-001
# DOC_ID: DOC-VALIDATOR-PATTERN-ID-REFERENCES-001
"""
doc_id: DOC-VALIDATOR-PATTERN-ID-REFERENCES-001
Validate pattern_id references in codebase
"""
...
def find_references():
    """Find all pattern_id references in codebase"""
    ...
    valid_ids = {p['pattern_id'] for p in registry.get('patterns', [])}

    pattern = re.compile(r'PATTERN-[A-Z0-9]+-[A-Z0-9-]+-[0-9]+')
    broken_refs = []
...
if __name__ == '__main__':
    ...
    print("\n=== Pattern ID References Validation ===")
    ...
    if result['broken_refs']:
        ...
        for ref in result['broken_refs'][:20]:

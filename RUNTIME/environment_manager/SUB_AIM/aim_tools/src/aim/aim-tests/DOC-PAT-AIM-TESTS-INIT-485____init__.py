# DOC_LINK: DOC-PAT-AIM-TESTS-INIT-485
"""Module: aim-tests
...
# Module metadata
__module_id__ = "aim-tests"
__ulid_prefix__ = "01001E"
__layer__ = "api"
module_import_name = "aim_tests"
...
while _pending:
    ...
    for _file_stem in list(_pending):
        _module_path = f"modules.aim_tests.{_file_stem}"
        try:
            ...
            if "_" in _file_stem:
                ...
                sys.modules[f"modules.aim_tests.{_alias}"] = _mod
                globals()[_alias] = _mod
